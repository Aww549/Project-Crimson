...
public class Spawner : MonoBehaviour
{
    ...
    void SpawnRow()
    {
        ...
        // --- REVERTED LOGIC ---
        // This is the old, stable logic. Elite waves are checked for before Runner waves.
    ...
    {
        int scrapToSpawn = 3;
        bool canSpawnSurvivor = GameDataManager.Instance != null && GameDataManager.Instance.gameData.survivorsRescuedThisRun == 0;
